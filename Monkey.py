...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/MONKEYexeee')
	back()
def linex():
	print("""\x1b[37m----------------------------------------------""")
def cls():
...
def menu(my_name,my_id):
	...
	linex()
	_____monkey_____ = input(' CHOOSE : ')
	if _____monkey_____ in ['1']:
		MONKEY_public()
	elif _____monkey_____ in ['2']:
		fileopt()
	elif _____monkey_____ in ['3','03']:
		passask()
		MONKEYresults()
	elif _____monkey_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____monkey_____ in ['5','05']:
		contact()
	elif _____monkey_____ in ['0']:
		passask()
...
def MONKEYresults():
    ok_file_path = '/sdcard/MONKEY/MONKEY-OK.txt'
    cp_file_path = '/sdcard/MONKEY/MONKEY-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/MONKEYexe')
